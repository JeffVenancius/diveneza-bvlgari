...
function WppBtn(props) {
	...
	return (
				<a href={"https://wa.me/553599236423?text=" + encodeURIComponent(props.mensagem)} target="_blank" rel="noreferrer" style={{textDecoration: "none", width:props.btnStyle.width, display:"flex", justifyContent:"center", alignItems: "center"}}>
